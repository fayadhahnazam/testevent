...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo e(asset('admin/dist/img/setting-mymakmal.png')); ?>" alt="Logo Mymakmal" height="200" width="200">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('profile.show')); ?>" class="nav-link">Profile</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo e(asset('admin/dist/img/AdminLTELogo.png')); ?>" alt="Logo MyMakmal" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block"><?php echo e(auth()->user()->email); ?></a> -->
                            ...
                            <a class="fw-bolder"><?php echo e(Auth::user()->name); ?></a>
                            <hr>
                            <a class="fw-bolder">Role Name:</a>
                            <a class="badge bg-success">Admin</a>
                            <?php endif; ?>
                            <?php if(Auth::user()->role_name=='Lecturer'): ?>
                                <a class="fw-bolder"><?php echo e(Auth::user()->name); ?></a>
                                <hr>
                                <a class="fw-bolder">Role Name:</a>
                                <a class="badge bg-info">Lecturer</a>
                            <?php endif; ?>
                            <?php if(Auth::user()->role_name=='Lab Assistant'): ?>
                                <a class="fw-bolder"><?php echo e(Auth::user()->name); ?></a>
                                <hr>
                                <a class="fw-bolder">Role Name:</a>
                                <a class="badge bg-warning">Lab Assistant</a>
                            <?php endif; ?>
                            <?php if(Auth::user()->role_name=='Student'): ?>
                                <a class="fw-bolder"><?php echo e(Auth::user()->name); ?></a>
                                <hr>
                                <a class="fw-bolder">Role Name:</a>
...
<?php /**PATH C:\laragon\www\testevent\resources\views/layouts/template.blade.php ENDPATH**/ ?>