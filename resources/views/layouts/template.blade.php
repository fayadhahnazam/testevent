...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('admin/dist/img/AdminLTELogo.png')}}" alt="Logo MyMakmal" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block">{{ auth()->user()->email }}</a> -->
                            ...
                            @endif
                            @if (Auth::user()->role_name=='Lecturer')
                                <a class="fw-bolder">{{ Auth::user()->name }}</a>
                                <hr>
                                <a class="fw-bolder">Role Name:</a>
                                <a class="badge bg-info">Lecturer</a>
                            @endif
                            @if (Auth::user()->role_name=='Lab Assistant')
                                <a class="fw-bolder">{{ Auth::user()->name }}</a>
                                <hr>
                                <a class="fw-bolder">Role Name:</a>
